...
public interface LiferayAdapter {
     ...
     */
    String createOrUpdateUser(long companyId, String screenName, String mobile, String nationalCode, String personalCode, String emailAddress, String firstName, String lastName) ;
